...
function About() {
  return (
    <div>
      <Hero backgroundImage="https://media.defense.gov/2011/Oct/21/2000207624/-1/-1/0/111017-F-ML202-006.JPG">
        <h1>Crisis Assessment Tool</h1>
        <h2>Ensure your Loved one is not at risk of Injury ?</h2>
      </Hero>
      <Container style={{ marginTop: 30 }}>
        <Row>
          <Col size="md-12">
            <h1>The Purpose of C.A.T </h1>
          </Col>
        </Row>
        <Row>
          <Col size="md-12">
